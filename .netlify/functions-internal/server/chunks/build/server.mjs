import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, ref, h, resolveComponent, computed, mergeProps, withCtx, createTextVNode, useSSRContext, provide, Suspense, Fragment, defineAsyncComponent, unref, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from 'vue';
import { m as createHooks, o as getContext, k as createError$1, t as toRouteMatcher, p as createRouter, q as defu, r as hasProtocol, s as joinURL, w as withQuery, v as sanitizeStatusCode, x as isScriptProtocol, y as executeAsync, z as parseQuery, A as withTrailingSlash, B as withoutTrailingSlash } from '../_/nitro.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<nav${ssrRenderAttrs(mergeProps({ class: "navbar" }, _attrs))} data-v-baced89c><div class="container navbar-container" data-v-baced89c>`);
  ...
  _push(`<div class="nav-links" data-v-baced89c>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "nav-link"
  }, {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-baced89c"]]);
...
export { _export_sfc as _, __nuxt_component_0$1 as a, server as s, tryUseNuxtApp as t };
